...
// Sınıf(ES6'dan itibaren kullanılır.) => nesne * 30
// ES5'de constructor yapısı vardır.
// ES5, (ES6, ES7 bu yenilikler ES5'e cevrilir.)
...
//     },
//     dogruCevap:"c",
//     cevabiKontrolEt: function(cevap){   // obje içerisinde fonksiyon tanımlama
//         return cevap === this.dogruCevap;   // girilen cevap bilgisi dogrucevap bilgisi ile aynıysa
//     }
// };
...
//Soruyu getir. Başlangıçta işaretlemeden önce sonraki butonunu kaldır.
...
ui.next_btn.addEventListener("click",function(){
    if(quiz.sorular.length != quiz.soruIndex+1){   // quiz indexi soru adedine eşit olmadığı sürece soruyu getir.
        ...
        ui.next_btn.classList.remove("show"); // yeni soru geldiğinde de buton kaldırılsın.
...
function optionSelected(option){
    clearInterval(counter); // seçim yaptığımız anda sayaç dursun
    clearInterval(counterLine);
